...
// Ver primero archivo ./funciones/suma.php para continuar con este ejercicio
include("./funciones/suma.php");
...
/*
Ejercicio
Cree una función que devuelva la suma de todos los enteros de una matriz, al cuadrado.squared_sum
*/
